"""Types and data structures for the embedded Radiacode library."""
...
# Format specifications for VSFR values
_VSFR_FORMATS = {
    VSFR.DEVICE_CTRL: "B",
    VSFR.DEVICE_LANG: "B",
    VSFR.DEVICE_ON: "B",
    ...
    VSFR.DISP_BRT: "B",
    VSFR.DISP_CONTR: "B",
    VSFR.DISP_OFF_TIME: "B",
    VSFR.DISP_ON: "B",
    VSFR.DISP_DIR: "B",
    VSFR.DISP_BACKLT_ON: "B",
    VSFR.SOUND_CTRL: "B",
    VSFR.SOUND_VOL: "B",
    VSFR.SOUND_ON: "B",
    VSFR.SOUND_BUTTON: "B",
    ...
    VSFR.DR_LEV1_uR_h: "f",
    VSFR.DR_LEV2_uR_h: "f",
    VSFR.DS_LEV1_100uR: "f",
    VSFR.DS_LEV2_100uR: "f",
    VSFR.DS_UNITS: "B",
    VSFR.CPS_FILTER: "B",
    VSFR.RAW_FILTER: "B",
    VSFR.DOSE_RESET: "B",
    VSFR.CR_LEV1_cp10s: "f",
    VSFR.CR_LEV2_cp10s: "f",
    VSFR.USE_nSv_h: "B",
